      ...
      <div className="max-w-4xl relative">
        ...
        <div className="sticky bottom-6 mt-6 sm:mt-8">
          <div className="flex gap-2 sm:gap-3 bg-white border border-gray-200 shadow-lg p-1.5 sm:p-2">
            ...
            />
            <button className="flex-shrink-0 px-3 sm:px-5 py-2.5 sm:py-3 bg-[#4E545C] text-white text-xs sm:text-sm font-semibold hover:bg-[#828a91] transition-colors cursor-pointer flex items-center gap-1.5 sm:gap-2">
              Send
            </button>
          </div>
        </div>
