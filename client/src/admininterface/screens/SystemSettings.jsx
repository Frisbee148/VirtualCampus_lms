            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3 py-2">
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full transition-colors self-start sm:self-auto ${settings.emailNotifications ? "bg-[#242424]" : "bg-gray-300"}`}
                >
                  <span
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3 py-2">
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full transition-colors self-start sm:self-auto ${settings.smsNotifications ? "bg-[#242424]" : "bg-gray-300"}`}
                >
                  <span
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-3 py-2">
                ...
                <button
                  ...
                  className={`w-11 h-6 rounded-full transition-colors self-start sm:self-auto ${settings.autoBackup ? "bg-[#242424]" : "bg-gray-300"}`}
                >
                  <span
