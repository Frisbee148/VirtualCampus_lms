          ...
          <div className="mt-4 max-w-[420px]">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none border border-gray-200 bg-white px-3 py-3 pr-10 text-sm sm:text-base font-semibold text-gray-900 shadow-sm outline-none transition-colors focus:border-[#1a7a7a]"
              >
                      ...
                      >
                        <label className="flex items-start justify-center px-2 sm:px-3 py-3 sm:py-3.5">
                          <input
                            ...
                            className="mt-1 h-4 w-4 cursor-pointer accent-[#1a7a7a] disabled:cursor-default"
                          />
                        </label>
