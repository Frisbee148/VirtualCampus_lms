...
const LibraryOperatorSidebar = ({ mobileOpen, onClose }) => {
  ...
  const menuItems = [
    {
      ...
      label: "Quick Actions",
      path: "/library-operator/dashboard",
    },
    {
      id: "issue",
      icon: ArrowLeftRight,
    ...
    <>
      ...
      >
        ...
        <div
          ...
          onClick={() => handleNavClick("/library-operator/profile")}
        >
          <img
            src="/Picture1.png"
            alt="Profile"
...
export default LibraryOperatorSidebar;