      ...
      <div className="max-w-6xl">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium bg-[#9f1239] text-white rounded-lg hover:bg-rose-900 transition-colors"
          >
            Add User
          </button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-6">
          <div className="relative w-full sm:max-w-xs">
            <input
              ...
              className="px-3 py-2 text-sm border border-gray-200 rounded-lg bg-white focus:outline-none focus:border-[#9f1239] w-full transition-colors"
            />
          </div>
          <select
            value={roleFilter}
            onChange={(e) => setRoleFilter(e.target.value)}
            className="px-3 py-2 text-sm border border-gray-200 rounded-lg bg-white focus:outline-none focus:border-[#9f1239] transition-colors w-full sm:w-auto"
          >
                    ...
                    <tr key={u.id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-3 py-3.5">
                        <button
                          ...
                          className="text-xs font-medium text-[#9f1239] hover:text-rose-900"
                        >
                          View
                        </button>
                      </td>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setSelectedUser(null)}>
          <div className="bg-white rounded-xl w-full max-w-lg max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex items-center gap-2 p-5 border-t border-gray-100">
              <button className="px-4 py-2 text-sm font-medium bg-[#9f1239] text-white rounded-lg hover:bg-rose-900 transition-colors">
                Edit User
              </button>
