...
const EVENTS = {
  ...
  "2026-04-14": [{ title: "Faculty Review Meeting", color: "#242424" }],
  ...
  "2026-04-28": [{ title: "Summer Intern Allotment", color: "#242424" }],
};
                ...
                {day && (
                  <>
                    <span className={`inline-flex items-center justify-center w-5 h-5 sm:w-6 sm:h-6 text-[10px] sm:text-xs font-medium ${
                      isToday(day) ? "bg-[#242424] text-white rounded-full" : "text-gray-700"
                    }`}>{day}</span>
                    {events.map((ev, j) => (
