    ...
    <HodLayout>
      <div className="max-w-6xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 mb-6">
          {[
            { label: "Dept Avg CGPA", value: "7.6", accent: "#4E545C" },
          ...
          <div className="bg-white border border-gray-100 p-3 sm:p-5 shadow-sm">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={attendanceData}>
                ...
                <Tooltip />
                <Line type="monotone" dataKey="value" stroke="#4E545C" strokeWidth={2.5} dot={{ r: 4, fill: "#4E545C" }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white border border-gray-100 p-3 sm:p-5 shadow-sm">
            ...
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={facultyWorkload} layout="vertical">
                ...
                <Tooltip />
                <Bar dataKey="students" fill="#4E545C" radius={[0, 3, 3, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
