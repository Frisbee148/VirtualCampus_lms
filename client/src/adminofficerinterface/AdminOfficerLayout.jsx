...
import AOTopHeader from "./components/AOTopHeader";
import AOSidebar from "./components/AOSidebar";

const AdminOfficerLayout = ({ children }) => {
  ...
  return (
    <div className="non-student-ui role-monochrome min-h-screen bg-[#f8f9fa] flex relative">
      ...
      <div className="flex-1 lg:ml-[240px] min-h-screen flex flex-col relative">
        <AOTopHeader onMenuToggle={() => setSidebarOpen(true)} />
