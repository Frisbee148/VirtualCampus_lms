...
const userStats = [
  { label: "Total Students", value: "2,486", accent: "#9f1239" },
...
const ROLE_COLORS = ["#9f1239", "#52525b", "#71717a", "#0f1117"];
          ...
          <div className="lg:col-span-2 bg-white p-3 sm:p-5 border border-gray-100">
            ...
            <ResponsiveContainer width="100%" height={240}>
              <BarChart data={growthData}>
                ...
                <Bar dataKey="students" fill="#9f1239" fillOpacity={0.8} name="Students" />
