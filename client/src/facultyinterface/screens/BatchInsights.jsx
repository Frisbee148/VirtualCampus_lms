...
const riskDistribution = [
  ...
  { name: "Safe", value: 53, color: "#242424" },
];
      ...
      <div className="max-w-5xl">
        <div className="flex items-center justify-between mb-4 sm:mb-6 flex-wrap gap-3">
          ...
          <select
            ...
            className="bg-[#242424] text-white px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium outline-none cursor-pointer w-full sm:w-auto"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 mb-6 sm:mb-8">
          {[
            { label: "Total Students", value: "78", accent: "#242424" },
