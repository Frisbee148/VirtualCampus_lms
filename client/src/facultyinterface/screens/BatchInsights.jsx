          ...
          <div className="bg-white border border-gray-100 p-3 sm:p-5 shadow-sm">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={attendanceData}>
                ...
                <Tooltip />
                <Bar dataKey="present" fill="#1a7a7a" animationDuration={1200} radius={[3, 3, 0, 0]} />
                <Bar dataKey="absent" fill="#e8a435" animationDuration={1200} radius={[3, 3, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white border border-gray-100 p-3 sm:p-5 shadow-sm">
            ...
            <ResponsiveContainer width="100%" height={200}>
              <BarChart data={cgpaData}>
                ...
                <YAxis tick={{ fontSize: 12 }} />
                <Tooltip />
                <Bar dataKey="count" fill="#1a7a7a" animationDuration={1400} radius={[3, 3, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
