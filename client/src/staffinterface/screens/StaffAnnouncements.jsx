          ...
          {[
            ...
            <button
              ...
              className={`px-3 py-1.5 text-xs font-medium transition-colors ${
                tab === t.key ? "bg-[#18181b] text-white" : "text-gray-500 hover:bg-gray-100"
              }`}
            >
              {t.label}
            </button>
          ...
          <div className="fixed inset-0 bg-black/50 z-[70] flex items-center justify-center p-4" onClick={() => setShowModal(false)}>
            <div className="bg-white w-full max-w-lg shadow-xl" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-gray-100">
                ...
                <button onClick={() => setShowModal(false)} className="flex items-center gap-1.5 px-4 py-2 text-xs bg-[#18181b] text-white font-medium hover:bg-[#1a1d27] transition-colors">
