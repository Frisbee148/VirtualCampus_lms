...
const ParentProfile = () => {
  ...
  const infoItems = [
    { label: 'Email', value: 'parent@guardian.io' },
    { label: 'Phone', value: '+91 98765 43210' },
    { label: 'Relation', value: 'Father' },
    { label: 'Ward Name', value: 'Kanye East' },
    { label: 'Ward Roll Number', value: 'CSE2022045' },
    { label: 'Ward Department', value: 'Computer Science & Engineering' },
  ];
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8">
          <div className="w-full sm:w-56 flex-shrink-0 space-y-3 sm:space-y-4">
            <div className="bg-white border border-gray-200 p-4 sm:p-6 text-center">
              ...
              <h3 className="text-xs sm:text-sm font-bold text-gray-900">Parent User</h3>
              <p className="text-[10px] sm:text-xs text-gray-400 mt-0.5">Guardian / Parent</p>
            </div>
          ...
          <div className="flex-1 bg-white border border-gray-200 p-4 sm:p-6">
            <h2 className="text-base sm:text-lg font-bold text-gray-900 mb-4 sm:mb-6">Guardian Information</h2>
