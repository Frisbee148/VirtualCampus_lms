...
const ParentAttendance = () => {
  ...
  return (
    <ParentLayout activeTab="Attendance">
      <div className="max-w-5xl">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Attendance Overview</h1>
        <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-6">Your ward's attendance record</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 mb-6 sm:mb-10">
          <div className="bg-white border border-gray-100 shadow-sm p-3 sm:p-5">
            <p className="text-[10px] sm:text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Overall Attendance</p>
